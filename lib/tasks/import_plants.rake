...
#   rails plants:import
#
# CSV fayli `db/uzflora_plants_final.csv` da bo'lishi kerak. CSV
...
namespace :plants do
  ...
  task import: :environment do
    path = Rails.root.join('db', 'uzflora_plants_final.csv')
    unless File.exist?(path)
      puts "XATO: #{path} topilmadi. uzflora_plants_final.csv ni db/ papkasiga joylang."
      next
    end
